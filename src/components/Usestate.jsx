            ...
            >
              ...
              <div className="flex items-center justify-center mb-6">
                <div className="relative w-32 h-32">
                  <div
                    className={`absolute inset-0 rounded-full flex items-center justify-center text-lg font-bold 
        ${darkMode ? " text-white" : "bg-white text-gray-900"}`}
                  ...
                  <div
                    className={`absolute inset-0 rounded-full border-[10px] 
                      ${
                        darkMode
                          ? "border-t-green-400 border-r-orange-400 border-gray-700"
                          : "border-t-blue-400 border-r-red-400 border-gray-300"
                      }`}
            ...
            >
              <h2 className="text-xl font-semibold mb-6">Open Projects</h2>
              {projects.map((project, index) => (
                ...
                >
                  <div className="flex items-center">
                    <div
                      className={`${project.color} w-10 h-10 rounded-lg flex items-center justify-center mr-4`}
                    >
                      {project.icon}
                    </div>
                    <div>
